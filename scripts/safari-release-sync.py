...
def publish():
    ...
    notes = (f'macOS Safari build of [{tag}](https://github.com/{UPSTREAM}/releases/tag/{tag}).\n\n'
             ...
             'Developer ID signed and Apple notarized. macOS only; iOS is not included.\n')
    ...
    for filename in (ASSET, 'SHA256SUMS'):
