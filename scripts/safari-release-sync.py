...
def publish():
    ...
    notes = (f'Safari builds of [{tag}](https://github.com/{UPSTREAM}/releases/tag/{tag}).\n\n'
             ...
             f'Download the [signed DMG](https://github.com/{DOWNSTREAM}/releases/download/{tag}/{ASSET}), drag SCU Plus to Applications, then enable it in Safari Settings → Extensions.\n'
             ...
             f'Developer testing/debugging artifact: [未签名 IPA](https://github.com/{DOWNSTREAM}/releases/download/{tag}/scu-plus-safari-ios-unsigned.ipa) is an unsigned Release build for technical testers. '
